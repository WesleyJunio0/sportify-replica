...
import SongList from "../componentes/SongList.jsx";
  ...
  return (
    <div className="artist">
      <div
        ...
        style={{
          backgroundImage: `linear-gradient(to bottom, rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0)), url(${artistaObj.banner})`,
        }}
      >
      ...
      <Link to={`/song/${randomIdfromArtist}`}>
        <FontAwesomeIcon
          className="single-item--artist  single-item__icon "
          icon={faCirclePlay}
        />
      </Link>
    </div>
